    ...
    if (isLoading && !postTypes.length) {
        return (
            <div {...blockProps}>
                <Placeholder
                    icon={icon}
                    label={__('Murdeni Post Grid Popup', 'murdeni-blocks')}
                >
                    <Spinner />
                </Placeholder>
            </div>
        ...
        <div {...blockProps}>
            <InspectorControls>
                ...
                <PanelBody title={__('Content Display', 'murdeni-post-grid')} initialOpen={false}>
                    ...
                    <ToggleControl
                        label={__('Display Full Content in Popup', 'murdeni-post-grid')}
                        checked={displayFullContent}
                        onChange={() => setAttributes({ displayFullContent: !displayFullContent })}
                    />
                </PanelBody>

                {/* Popup Settings */}
                <PanelBody title={__('Popup Settings', 'murdeni-post-grid')} initialOpen={false}>
                    <ToggleControl
                        label={__('Display Popup Button', 'murdeni-post-grid')}
                        checked={displayPopupButton}
                        onChange={() => setAttributes({ displayPopupButton: !displayPopupButton })}
                    />

                    {displayPopupButton && (
                        <TextControl
                            label={__('Button Text', 'murdeni-post-grid')}
                    ...
                    <p className="components-base-control__help">
                        {__('Note: Even without a button, clicking anywhere on the card will open the popup.', 'murdeni-post-grid')}
                    </p>
                </PanelBody>
            ...
            <ServerSideRender
                block="murdeni/post-grid-popup"
                attributes={attributes}
                EmptyResponsePlaceholder={() => (
                    <Placeholder
                        icon={icon}
                        label={__('Murdeni Post Grid Popup', 'murdeni-post-grid')}
                    >
